...
import net.matt.tutorialmod.block.custom.SoundBlock;
...
public class ModBlocks {
    ...
    public static final Block END_RUBY_ORE = registerBlock("end_ruby_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(2, 5), FabricBlockSettings.copyOf(Blocks.END_STONE).strength(3.5f)));
    ...
    private static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(Registries.BLOCK, new Identifier(Tutorial_mod.MOD_ID, name), block);
    }
    private static Item registerBlockItem(String name, Block block) {
        return Registry.register(Registries.ITEM, new Identifier(Tutorial_mod.MOD_ID, name),
                new BlockItem(block, new FabricItemSettings()));
    }

    public static void registerModBlocks() {
        Tutorial_mod.LOGGER.info("Registering ModBlocks for " + Tutorial_mod.MOD_ID);
    }
}
